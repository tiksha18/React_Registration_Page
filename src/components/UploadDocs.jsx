        ...
        <React.Fragment>
            ...
            <div className="uploading-docs">
                <div className="upload-aadhar">
                    ...
                    <div className="hero">
                        <p className="data">UPLOAD PHOTO OF FRONT SIDE OF AADHAR CARD</p>
                        ...
                        <p className="data">UPLOAD PHOTO OF BACK SIDE OF AADHAR CARD</p>
            ...
            <div className="button-docs-upload">
                <button type="button" class="btn btn-outline-success btn-width " > <Link to="/uploaddocumentsmore"> Next ➜ </Link> </button>
            </div>
        </React.Fragment>
    );
}
